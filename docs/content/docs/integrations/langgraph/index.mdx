...
description: Bring your LangChain agents to your users with CopilotKit via AG-UI.
hideHeader: true
---
...
<FrameworkOverview
  ...
  frameworkIcon={<LangchainIcon className="h-14 w-14" />}
  header="Bring your LangChain agents to your users"
  subheader="Give your LangChain agents real user-interactivity using CopilotKit and AG-UI. Build rich, interactive, agent-powered applications."
