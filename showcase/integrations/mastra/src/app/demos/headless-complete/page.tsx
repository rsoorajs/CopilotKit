 ...
 *     from the low-level hooks inside `use-rendered-messages.tsx`.
 *
...
// Routes through the shared `/api/copilotkit` runtime (the LangGraph-Python
// reference uses a dedicated mcp-apps route to wire in Excalidraw; Mastra
// skips mcp-apps as a truthful architectural limitation, so we fall back
...
function Chat() {
  ...
  // wouldn't scope to this agent and custom message renderers would early-
  // return null.
  return (
