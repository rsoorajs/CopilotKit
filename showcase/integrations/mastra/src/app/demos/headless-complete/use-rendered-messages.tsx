 ...
 *
 * Text rendering: plain text (a `<div>` with `whitespace-pre-wrap`) rather
 * than a markdown pipeline. Rationale: the cell's goal is to show what
 * "truly headless" looks like — every piece of composition lives in user
 * code — so pulling in a markdown library here would re-hide a chunk of
