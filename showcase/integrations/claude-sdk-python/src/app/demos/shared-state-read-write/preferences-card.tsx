...
/**
 * Sidebar card — the only place the user edits their preferences.
 *
 * Every change calls `onChange`, which the parent page routes straight
 * into `agent.setState({ preferences: ... })`. On the next turn the
 * Claude backend reads that object back out of agent state and prepends
 * it onto the system prompt, so the model's reply visibly adapts.
 */
