 ...
 * `agent.setState({ preferences: ... })`. On the next turn, the AG-UI runtime
 * injects the entire shared state (including these preferences) as a system
 * context message into the conversation, so the agent's reply visibly adapts.
 */
