...
/**
 * Generative UI Interrupt -- Not Supported by CrewAI Crews.
 *
    ...
    <div className="flex justify-center items-center h-screen w-full">
      <div className="max-w-xl px-6 py-8 rounded-2xl border border-neutral-200 bg-white text-center">
        <h1 className="text-xl font-semibold mb-2">
          Not supported by crewai-crews
        </h1>
        <p className="text-sm text-neutral-600 mb-4">
          Generative UI Interrupt requires a pause/resume primitive that CrewAI
