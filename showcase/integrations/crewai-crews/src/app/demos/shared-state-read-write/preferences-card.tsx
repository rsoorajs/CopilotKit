 ...
 * `agent.setState({ preferences: ... })`. On the next turn, the CrewAI flow's
 * `chat` step reads that same object out of agent state and prepends a
 * preferences block to the system message, so the agent's reply visibly
 * adapts.
 */
    ...
    >
      <div>
        ...
        <p className="text-xs text-[#57575B] mt-1">
          These are written into agent state. The CrewAI flow reads them on
          every turn.
        </p>
      </div>
