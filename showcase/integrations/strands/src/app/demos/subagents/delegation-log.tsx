...
const STATUS_COLOR: Record<Delegation["status"], string> = {
  running: "text-[#838389]",
 ...
 * the Strands ToolBehavior hook for each sub-agent tool emits a
 * `StateSnapshotEvent` immediately after the tool returns, so this
 * panel reflects the new entry before the supervisor's text response
 * finishes streaming.
 */
