...
// Mirrors the LangGraph reference's Preferences TypedDict.
 ...
 * into `agent.setState({ preferences: ... })`. On the next turn, the Spring
    ...
    >
      <div>
        ...
        <p className="text-xs text-[#57575B] mt-1">
          These are written into agent state. Spring reads them on every turn
