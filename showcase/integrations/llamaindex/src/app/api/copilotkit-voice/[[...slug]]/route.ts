// Dedicated runtime for the /demos/voice cell (LlamaIndex).
//
// Goals
// -----
...
//
// The underlying agent is the shared HttpAgent -> llamaindex FastAPI router
// other chat demos use: voice is an input-modality concern, not an
// agent-behavior concern.
//
