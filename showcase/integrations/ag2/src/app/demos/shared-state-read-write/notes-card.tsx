 ...
 *
 * The agent writes these via its `set_notes` tool, which mutates the
 * AG2 ContextVariables and returns a ReplyResult. AG-UI propagates the
 * updated state back to the UI, where `useAgent({ updates: [OnStateChanged] })`
