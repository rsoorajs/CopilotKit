...
//
// `interrupt-headless` exposes the headless `useInterrupt` API outside
// the chat surface — same primitive as `gen-ui-interrupt`, just driven
// from arbitrary app UI. It still requires a graph-interrupt runtime.
// The built-in-agent uses TanStack AI's chat-completions adapter, which
// has no graph-interrupt primitive. See `langgraph-python` for a
