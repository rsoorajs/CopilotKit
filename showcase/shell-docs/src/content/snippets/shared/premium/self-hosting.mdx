...
Before starting, make sure the following are in place. The [How the Intelligence Platform Works](/concepts/intelligence-platform) page explains the layering in more depth.
...
- **Understand how it works:** [How the Intelligence Platform Works](/concepts/intelligence-platform) — architecture, multi-tenancy model, platform layering, and the decision between hosted and self-hosted
