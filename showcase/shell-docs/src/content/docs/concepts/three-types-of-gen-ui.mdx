...
- **Full overview with diagrams** — [Generative UI Overview](/concepts/generative-ui-overview) covers the application surfaces (chat, chat-plus, chatless), the freedom-vs-control attributes in detail, and ecosystem mapping.
...
- **Spec details** — [Declarative gen-UI specs](/generative-ui) for A2UI, MCP-Apps, Open JSON UI, and others.
