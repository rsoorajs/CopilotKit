...
- **Architecture deep-dive** — [Intelligence Platform internals](/learn/intelligence-platform) covers the control-plane / data-plane split, the three workloads, and the operational model.
