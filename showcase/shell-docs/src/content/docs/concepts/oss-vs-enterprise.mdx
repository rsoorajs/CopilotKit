...
- **Hosted setup** — [Copilot Cloud](https://cloud.copilotkit.ai) for the hosted Intelligence Platform.
...
- **Architecture deep-dive** — [Intelligence Platform internals](/concepts/intelligence-platform) covers the control-plane / data-plane split, the three workloads, and the operational model.
