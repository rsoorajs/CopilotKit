...
7. Threads, persistence, and realtime sync (when configured) are mediated by the [Intelligence Platform](/premium/intelligence-platform) — the Enterprise backend that sits beside the runtime.
...
- **Enterprise deployment** — [Intelligence Platform](/premium/intelligence-platform) covers Threads, Persistence, Observability, and the hosted-vs-self-hosted decision.
