...
<Card
  title="Next: Frontend tools →"
  href="/tutorials/ai-todo-app/step-4-frontend-tools"
  description="Let the copilot take actions on the todo list with useFrontendTool."
/>
