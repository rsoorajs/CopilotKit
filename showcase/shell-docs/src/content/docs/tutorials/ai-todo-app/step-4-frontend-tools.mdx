...
<Cards>
<Card
  title="← Previous: Read app state"
  href="/tutorials/ai-todo-app/step-3-copilot-readable-state"
  description="Use useCopilotReadable so the copilot can answer questions about your todos."
/>
<Card
  title="Next: Wrap up →"
  href="/tutorials/ai-todo-app/next-steps"
