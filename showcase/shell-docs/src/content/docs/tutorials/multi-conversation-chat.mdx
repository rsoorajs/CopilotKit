...
<OpsPlatformCTA
  variant="inline"
  title="Need an Enterprise Intelligence Platform project?"
...
<Steps>
  ...
  <Step>
    ...
    import { useThreads } from "@copilotkit/react-core"; // [!code highlight]
  ...
  <Step>
    ...
    import { useState } from "react";
    import type { Thread } from "@copilotkit/react-core";
  ...
  <Step>
    ...
    import { CopilotChat } from "@copilotkit/react-core"; // [!code highlight]
...
- **Understand how it works:** [How Threads & Persistence Work](/premium/threads-explained) — architecture, event replay model, and WebSocket sync
